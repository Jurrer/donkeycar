...
def get_model_by_type(model_type: str, cfg: 'Config') -> Union['KerasPilot', 'FastAiPilot']:
    ...
    from donkeycar.parts.keras import KerasCategorical, KerasLinear, \
        ...
        KerasLSTM, Keras3D_CNN, KerasAdvanced, KerasAdvancedLite
    ...
    if used_model_type == "linear":
        ...
        kl = Keras3D_CNN(interpreter=interpreter, input_shape=input_shape,
                         seq_length=cfg.SEQUENCE_LENGTH)
    elif used_model_type == "advanced":
        kl = KerasAdvanced(interpreter=interpreter, input_shape=input_shape)
    elif used_model_type == "advancedlite":
        kl = KerasAdvancedLite(interpreter=interpreter, input_shape=input_shape)
    else:
